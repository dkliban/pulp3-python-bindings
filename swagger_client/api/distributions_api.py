...
class DistributionsApi(object):
    ...
    def distributions_list(self, **kwargs):  # noqa: E501
        ...
        :param str base_path: 
        :param str base_path__contains: 
        :param str base_path__icontains: 
        :param str base_path__in: Multiple values may be separated by commas.
    ...
    def distributions_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'name__in', 'base_path', 'base_path__contains', 'base_path__icontains', 'base_path__in', 'cursor']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
